...
class TestSubWhisperCore:
    ...
    def test_find_ffmpeg(self) -> None:
        ...
        if ffmpeg_path:
            ...
            try:
                ...
                pytest.fail(
                    f"FFmpeg executable found but not functional: {ffmpeg_path}"
                )
        else:
    ...
    def test_extract_audio_mock(self, temp_dir: Path, mock_args: Mock) -> None:
        ...
        with patch("subwhisper.find_ffmpeg", return_value="ffmpeg"), patch(
            ...
            output_audio.write_bytes(
                b"fake audio data" * 1000
            )  # Make it reasonable size
    ...
    def test_transcribe_audio_file_not_found(
        self, temp_dir: Path, mock_args: Mock
    ) -> None:
    ...
    @pytest.mark.unit
    @pytest.mark.timeout(60)
    def test_transcribe_audio_model_loading_failure(
        self, sample_audio_data: Path, mock_args: Mock
    ) -> None:
        """Test transcription with model loading failure."""
        with patch(
            "whisper.load_model", side_effect=Exception("Model download failed")
        ):
            result = subwhisper.transcribe_audio(str(sample_audio_data), mock_args)
            assert result is None
    ...
    @pytest.mark.unit
    @pytest.mark.timeout(60)
    def test_transcribe_audio_with_language_specified(
        self, sample_audio_data: Path, mock_args: Mock
    ) -> None:
    ...
    @pytest.mark.unit
    @pytest.mark.timeout(60)
    def test_transcribe_audio_scipy_loading_success(
        self, temp_dir: Path, mock_args: Mock
    ) -> None:
    ...
    @pytest.mark.unit
    @pytest.mark.timeout(60)
    def test_transcribe_audio_stereo_to_mono(
        self, temp_dir: Path, mock_args: Mock
    ) -> None:
    ...
    @pytest.mark.unit
    @pytest.mark.timeout(60)
    def test_transcribe_audio_int32_conversion(
        self, temp_dir: Path, mock_args: Mock
    ) -> None:
    ...
    @pytest.mark.unit
    @pytest.mark.timeout(60)
    def test_transcribe_audio_keyboard_interrupt(
        self, sample_audio_data: Path, mock_args: Mock
    ) -> None:
    ...
    @pytest.mark.unit
    @pytest.mark.timeout(60)
    def test_transcribe_audio_transcription_exception(
        self, sample_audio_data: Path, mock_args: Mock
    ) -> None:
    ...
    @pytest.mark.unit
    @pytest.mark.timeout(60)
    def test_transcribe_audio_invalid_result(
        self, sample_audio_data: Path, mock_args: Mock
    ) -> None:
    ...
    @pytest.mark.unit
    @pytest.mark.timeout(60)
    def test_transcribe_audio_outer_exception_handler(
        self, sample_audio_data: Path, mock_args: Mock
    ) -> None:
    ...
    @pytest.mark.unit
    @pytest.mark.timeout(60)
    def test_process_video_mock(
        self, temp_dir: Path, sample_video_file: Path, mock_args: Mock
    ) -> None:
    ...
    @pytest.mark.unit
    @pytest.mark.timeout(60)
    def test_process_video_transcription_failure(
        self, temp_dir: Path, mock_args: Mock
    ) -> None:
    ...
    @pytest.mark.unit
    @pytest.mark.timeout(60)
    def test_process_video_with_output_path(
        self, temp_dir: Path, mock_args: Mock
    ) -> None:
        ...
        with patch("subwhisper.extract_audio") as mock_extract, patch(
            ...
            mock_generate_srt.assert_called_once_with(
                mock_transcription["segments"], str(output_path), None
            )
    ...
    def test_process_video_batch_mode(self, temp_dir: Path, mock_args: Mock) -> None:
        ...
        with patch("subwhisper.extract_audio") as mock_extract, patch(
            ...
            mock_generate_srt.assert_called_once_with(
                mock_transcription["segments"], str(expected_output), None
            )

    @pytest.mark.unit
    @pytest.mark.timeout(60)
    def test_process_video_with_post_processing(
        self, temp_dir: Path, mock_args: Mock
    ) -> None:
    ...
    @pytest.mark.unit
    @pytest.mark.timeout(60)
    def test_process_video_post_processing_failure(
        self, temp_dir: Path, mock_args: Mock
    ) -> None:
    ...
    @pytest.mark.unit
    @pytest.mark.timeout(60)
    def test_process_video_post_processing_timeout(
        self, temp_dir: Path, mock_args: Mock
    ) -> None:
    ...
    @pytest.mark.unit
    @pytest.mark.timeout(60)
    def test_process_video_post_processing_exception(
        self, temp_dir: Path, mock_args: Mock
    ) -> None:
    ...
    @pytest.mark.unit
    @pytest.mark.timeout(60)
    def test_process_video_general_exception(
        self, temp_dir: Path, mock_args: Mock
    ) -> None:
    ...
    def test_real_audio_extraction(self, temp_dir: Path) -> None:
        ...
        try:
            ...
            cmd = [
                ...
                "lavfi",
                "-i",
                "testsrc2=duration=3:size=320x240:rate=1",
                "-f",
                "lavfi",
                "-i",
            ...
            if result.returncode == 0 and test_video.exists():
                ...
                extracted_path = subwhisper.extract_audio(
                    str(test_video), str(output_audio)
                )

                assert Path(extracted_path).exists()
                assert (
                    Path(extracted_path).stat().st_size > 1000
